...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BackendSpec":    schema_pkg_apis_balancer_v1alpha1_BackendSpec(ref),
		"github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BalancerList":   schema_pkg_apis_balancer_v1alpha1_BalancerList(ref),
		"github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BalancerPort":   schema_pkg_apis_balancer_v1alpha1_BalancerPort(ref),
		"github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BalancerSpec":   schema_pkg_apis_balancer_v1alpha1_BalancerSpec(ref),
		"github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BalancerStatus": schema_pkg_apis_balancer_v1alpha1_BalancerStatus(ref),
...
func schema_pkg_apis_balancer_v1alpha1_BalancerList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.Balancer"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.Balancer", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_balancer_v1alpha1_BalancerPort(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "BalancerPort containers the endpoints and exposed ports.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_balancer_v1alpha1_BalancerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BackendSpec"),
									},
								},
							},
						},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BalancerPort"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BackendSpec", "github.com/netlops/balancer/pkg/apis/balancer/v1alpha1.BalancerPort"},
	}
}

func schema_pkg_apis_balancer_v1alpha1_BalancerStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
