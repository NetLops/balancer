...
import (
	...
	balancer "github.com/netlops/balancer/pkg/client/informers/externalversions/balancer"
...
func (f *sharedInformerFactory) Balancer() balancer.Interface {
	return balancer.New(f, f.namespace, f.tweakListOptions)
}
